...
export declare type Defined<T extends object> = Filter<T, undefined, "<-extends">;
export declare type Pick<T extends object, S, M extends Match = "default"> = Exclude<keyof T, Filter<T, S, M>>;
export declare type PickGroups<T extends object, O extends PickGroupsOption> = And<If<Extends<"defined", O>, Defined<T>, keyof T>, If<Extends<"optional", O>, Optional<T>, keyof T>, If<Extends<"readonly", O>, Readonly<T>, keyof T>, If<Extends<"required", O>, Required<T>, keyof T>, If<Extends<"undefined", O>, Undefined<T>, keyof T>, If<Extends<"writable", O>, Writable<T>, keyof T>>;
export declare type ReadonlyDefined<T extends object> = PickGroups<T, "defined" | "readonly">;
export declare type ReadonlyUndefined<T extends object> = PickGroups<T, "readonly" | "undefined">;
export declare type Undefined<T extends object> = Pick<T, undefined, "<-extends">;
export declare type WritableDefined<T extends object> = PickGroups<T, "defined" | "writable">;
export declare type WritableUndefined<T extends object> = PickGroups<T, "undefined" | "writable">;
